...
from ragathon.chunking.sentence import DanishSentenceSplitter, SentenceSplitter
...
class NaiveChunkingVectorPipeline(RAGPipeline):
    def __init__(self, markdown_file_path: Path, language: str, output_dir: Path):
        ...
        self._embedder =  instantiate_embedder(settings=app_settings)

        self._index = VectorIndex(storage_dir=self._index_storage_dir, embedder=self._embedder)
    ...
    async def _load_or_create_chunked_set(
        ...
        # sentence_splitter = DanishSentenceSplitter()
        # splitter = ParagraphSplitter(max_chunk_size=self._config.max_chunk_size, sentence_splitter=sentence_splitter)
        ...
        for section in doc.sections:
            ...
            for raw_chunk in raw_chunks:
                ...
                #chunked_text.text = section.heading +": "+ chunked_text
